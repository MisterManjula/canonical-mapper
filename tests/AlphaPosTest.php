...
use CanonicalMapper\Source\Alpha\AlphaPosAdapter;
...
final class AlphaPosTest extends TestCase
{
    ...
    {
        $result = (new Mapper())->run(new AlphaPosAdapter(), self::fixture('equivalence/alpha.json'));
    ...
    public function testADefinitionThatContradictsAnEarlierOneIsRefused(): void
    {
        ...
        (new Mapper())->run(new AlphaPosAdapter(), <<<'JSON'
            {
                "menu": {
                    "products": [
    ...
    public function testAnExportThatIsNotJsonIsRefused(): void
    {
        ...
        (new Mapper())->run(new AlphaPosAdapter(), 'PLU;NAME;PRICE');
    }
